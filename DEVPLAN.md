...
| # | 功能 | 说明 | 工作量 | 状态 |
|---|------|------|--------|------|
| 11 | 车型系统 | 轻/中/重/突击炮分化，策略深度质变 | 大 | ✅ |
| 12 | 车型选择界面 | 主菜单选车，属性预览 | 中 | ✅ |
| 13 | 车型专属能力 | 侦察/冲刺/铁壁/蓄力射击 | 大 | 后续 |
| 14 | 车型克制关系 | 策略选择更有深度 | 小 | 后续 |
...
├── ai.js           AI
├── tank.js         坦克
├── tank-classes.js 车型数据定义
├── tutorial.js     新手引导
├── dynamic-difficulty.js  动态难度
├── game.js         主循环+UI
└── main.js         入口
```
...
### Phase 2：v1.3 车型系统 ✅ 已完成（2026-08-24）
- [x] 创建 tank-classes.js 数据定义
- [x] 修改 Tank 类支持车型属性
- [x] 主菜单车型选择界面
- [x] AI 随机/智能选车
- [x] 修改 bullet.js 支持穿墙（突击炮）
- [x] 测试验证平衡性 - 66个测试用例全部通过
- [x] 更新文档

**详细设计见 DESIGN-TANK-CLASSES.md**
